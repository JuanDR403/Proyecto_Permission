...
<div class="container">
  ...
  <span>RUTAS</span>
            ...
            <br>
            <div class="card">
        <button onclick="location.href='http://proyecto.test:8081/LIDrutas'">
  <span>LIDERES RUTAS</span>
    ...
    <div class="col-8">
      <div class="card-body">
        <section>
                         <img src="../img1/xd.jpg" class="img-fluid" alt="...">
                         <img src="../img1/tra2.jpg" class="img-fluid" alt="...">
                         <img src="../img1/tra3.jpg" class="img-fluid" alt="...">
                     </section>
