...
<div class="container">
  ...
  <span>ESCANEAR</span>
    ...
    <p class="name-client"> Lider Restaurante
        <span>Escanea QR
        </span>
    </p>
      ...
      <div class="card-body">
        ...
        <div class="cardi">
            <form action="" method="post">
                <center>
            <img src="../img1/usser.png" alt="" class="foto"><br>
            ...
            <label>Porcentaja Descuento</label>
            <input type="number" name="edad" class="form-control" style="width: 65%" placeholder="50% o 75%" ><br>
            <br>
            <button class="guardar"><span>Guardar</span></button>
        </center>
        </form>
        </div>
    </center>
