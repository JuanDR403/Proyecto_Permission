...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <img src="../img1/sen3.jpg" class="img-fluid" alt="...">
  ...
  <img src="../img1/tra3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
  ...
  <div class="card-body">
    <a href="{{ route('APEsena') }}" class="card-link">Consultar</a>
  </div>
</div>
    ...
    <div class="col-8">
        <div class="card mb-3">
  <img src="../img1/sen1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
